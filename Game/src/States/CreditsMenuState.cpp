...
void CreditsMenuState::Enter() {
	...
	if (font) {
		...
		AddTextEntry("Kelsey Ishmael", font, sf::Vector2f(50.0f, 420.0f));
		AddTextEntry("Wade Shwallon", font, sf::Vector2f(50.0f, 450.0f));
		AddTextEntry("Andy Madruga", font, sf::Vector2f(50.0f, 480.0f));
		AddTextEntry("Charlie Prouse", font, sf::Vector2f(50.0f, 510.0f));
		AddTextEntry("Roger Prouse", font, sf::Vector2f(50.0f, 540.0f));

		AddTextEntry("Artist", font, sf::Vector2f(300.0f, 350.0f));
		AddTextEntry("Stacey Miller", font, sf::Vector2f(300.0f, 390.0f));
		AddTextEntry("Jesse Williams", font, sf::Vector2f(300.0f, 420.0f));

		AddTextEntry("Audio Engineer", font, sf::Vector2f(300.0f, 480.0f));
		AddTextEntry("Jesse Williams", font, sf::Vector2f(300.0f, 520.0f));

		AddTextEntry("Special Thanks", font, sf::Vector2f(550.0f, 350.0f));
		AddTextEntry("Zach Gurley", font, sf::Vector2f(550.0f, 390.0f));
		AddTextEntry("Jeff Chilson", font, sf::Vector2f(550.0f, 420.0f));
	}
}
